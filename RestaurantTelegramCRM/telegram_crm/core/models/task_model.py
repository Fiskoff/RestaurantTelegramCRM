...
class Task(BaseModel):
    ...
    notified_one_day: Mapped[bool] = mapped_column(default=False)
    notified_today: Mapped[bool] = mapped_column(default=False)
    notified_two_hours: Mapped[bool] = mapped_column(default=False)
