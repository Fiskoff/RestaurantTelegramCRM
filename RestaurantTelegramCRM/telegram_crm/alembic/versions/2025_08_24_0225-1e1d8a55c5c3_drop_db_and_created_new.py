...
Revision ID: 1e1d8a55c5c3
Revises: 
Create Date: 2025-08-24 02:25:59.385864
...
def upgrade() -> None:
    ...
    sa.Column('sector', sa.Enum('BAR', 'HALL', 'KITCHEN', name='sectorstatus'), nullable=True),
